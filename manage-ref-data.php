...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Styles/manage-ref-data-BreadCrumbs.css">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

    <script>
        function setActiveTab(tabId, tabName) {
            $.ajax({
                url: '/manage-ref-data-tab.php',
                type: 'POST',
...
<div class="container">
    ...
    <?php if ($_SESSION['mode'] == 'light'): ?>
        <div class="breadcrumb flat">
            <a href="/manage-ref-data-home.php">Manage Reference Data</a>
            <a href="#">Tree/Logs</a>
    ...
    <div class="tabset">
        <!-- Tab 1 -->
        <input type="radio" name="tabset" id="tab1" aria-controls="Request" <?php echo ($activeTab == 'tab1') ? 'checked' : ''; ?> onclick="setActiveTab('tab1', 'Species')">
        <label for="tab1">Species</label>
        <!-- Tab 2 -->
        <input type="radio" name="tabset" id="tab2" aria-controls="Deliver" <?php echo ($activeTab == 'tab2') ? 'checked' : ''; ?> onclick="setActiveTab('tab2', 'Condition Status')">
        ...
        <div class="tab-panels">
            ...
            <section id="Deliver" class="tab-panel">
                <h2>B. Condition</h2>
                <p><strong>CONDITION:</strong> This should be the condition status of the tree</p>
            </section>

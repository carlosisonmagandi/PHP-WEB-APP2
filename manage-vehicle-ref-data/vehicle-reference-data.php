...
<div class="container">
    ...
    <div class="tabset">
        <!-- Tab 1 -->
        <input type="radio" name="tabset" id="tab1" aria-controls="vehicleType" <?php echo ($activeTab == 'tab1') ? 'checked' : ''; ?> onclick="setActiveTab('tab1', 'Vehicle Type')">
        <label for="tab1">Vehicle type</label>
        <!-- Tab 2 -->
        <input type="radio" name="tabset" id="tab2" aria-controls="vehicleCondition" <?php echo ($activeTab == 'tab2') ? 'checked' : ''; ?> onclick="setActiveTab('tab2', 'Vehicle Condition')">
        <label for="tab2">Vehicle condition</label>
        <!-- Tab 3 -->
        <input type="radio" name="tabset" id="tab3" aria-controls="vehicletStatus" <?php echo ($activeTab == 'tab3') ? 'checked' : ''; ?> onclick="setActiveTab('tab3', 'Vehicle Status')">
        <label for="tab3">Vehicle status</label>

        <div class="tab-panels">
            <section id="equipmentType" class="tab-panel">
                <!-- Call the table display -->
                 <?php  include("../manage-vehicle-ref-data/VehicleType/vehicle-display.php"); ?>
            </section>

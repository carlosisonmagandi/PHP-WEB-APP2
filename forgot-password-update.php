...
if (isset($_POST['forgotPasswordId'])) {
    ...
    if ($password == $confirmPassword) {
        if (validatePassword($password)) {
            ...
            $queryUpdate = "UPDATE account SET password='" . mysqli_real_escape_string($connection, $hashedPassword) . "' WHERE id='" . mysqli_real_escape_string($connection, $_SESSION['forgotPasswordId']) . "'";

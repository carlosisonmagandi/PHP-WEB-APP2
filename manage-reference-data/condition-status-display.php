...
<body>
<input type="button" id="addButton" value="Add new record" class="btn btn-primary">
    ...
    function fetchDataFromDB() {
        $.ajax({
            ...
            success: function(response) {
                $('#conditionStatusTable').DataTable().clear().draw();
                $.each(response, function(index, row) {
                    ...
                    $('#conditionStatusTable').DataTable().row.add([
                        row.id,
                        row.condition_type,

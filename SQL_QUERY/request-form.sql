...
desc request_form;
UPDATE  request_form SET type_of_requested_item='Coals' where id =65;
DELETE FROM request_form WHERE id NOT IN (65);
...
UPDATE request_form SET approval_status='Pending for Approval' WHERE id in(79,75);
...
SELECT * FROM request_form;
Desc request_form;
UPDATE request_form SET approval_status='Pending for Approval' WHERE ID IN (66);
UPDATE request_form SET date_of_completion='2024-10-20 13:00:00' WHERE ID IN (64,65);

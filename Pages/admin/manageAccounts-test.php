<?php
    ...
    <body>
        ...
        <div class="container mt-4"  style="padding:3%">
            <h2>Users</h2>
            <input type="text" id="searchInput" class="form-control mb-2" style="width:20%" placeholder="Search...">
            <div id="refreshDiv">
        ...
        <script>
            ...
            var originalData; // Store the original data
                ...
                function refreshDiv() {
                    ...
                    // Fetch the data through server
                    xhttp.open("GET", "fetch_accounts.php", true);
                    xhttp.send();
                }

                // Interval for refreshing the div (5secs)

        ...
        <div class="row">
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary text-white mb-4">
                    <div class="card-body" id="confiscatedRecord">Total number of confiscated forest product, conveyances and equipments:</div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-white mb-4">
                    <div class="card-body" id="donatedRecord">Total number of completed donations (Forest Products)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-danger text-white mb-4">
                    <div class="card-body" id="emvValue">Forest Product's Estimated Value (Php)</div>
                    <div class="card-footer d-flex align-items-center justify-content-between">
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) { 
                $('#confiscatedRecord').html('Total number of confiscated forest product, conveyances and equipments:<br><span style="float: left;font-size:20px;color:#0056b3"><b>' + data[0].total_count + '</b></span>');
        ...
        //Get total records od Donations
        ...
        $.ajax({
            ...
            $('#donatedRecord').html('Total number of completed donations (Forest Products)<br><span style="float: left;font-size:20px;color:#e0a800              "><b>' + data.total_quantity + '</b></span>');
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(data) { 
                $('#allUser').html('Active Users: <br><span style="float: left;margin-top:10px;font-size:20px;color:#218838"><b>' + data[0].total_count_users + '</b></span>');
        ...
        $.ajax({
            ...
            userDataFieldStaff = '<span><b>' + data[0].role_field_staff + '</b></span>';
            },
            error: function(xhr, status, error) {
                console.error('Error fetching condition data: ', error);
            }
        ...
        $.ajax({
            ...
            success: function(data) {
            //  console.log( data[0].role_admin);
            $('#emvValue').html('Forest Product\'s Estimated Value Php: <br><span style="float: left;font-size:20px;margin-top:10px;color:#c82333"><b>' + 'Php. '+ data[0].total_emv + '</b></span>');
            ...
            html:`
                <style>                    
                    ...
                    <div class="parent">
                        ...
                        <div class="div5">Field Staff:</div>
                        <div class="div3">${userDataAdmin}</div>
                        <div class="div4">${userDataStaff}</div>
                        <div class="div6">${userDataFieldStaff}</div>
                    </div> 
                    <br>                      
            `
        });
    ...
    function updateChart(data) {
        ...
        data.forEach(function(productData) {
            var product = productData.label;
            var values = productData.data;
            ...
            if (values.length === 12) {
                ...
                console.warn(`Data for ${product} does not have 12 months. Data:`, values);
            }
        });
        ...
        window.lineChart = new Chart(ctxBar, {
            type: 'bar',
            data: {
                labels: labels,
                datasets: datasets
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Confiscated Forest Products Over Time',
                        font: {
                            size: 14,
                            weight: 'bold'
                        }
                ...
                scales: {
                    x: {
                        beginAtZero: true,
                        stacked: false,  // Disable stacking of bars on the x-axis
                        title: {
                            display: true,
                            text: 'Month'
                        }
                    ...
                    y: {
                        beginAtZero: true,
                        stacked: false,  // Disable stacking of bars on the y-axis
                        title: {
                            display: true,
                            text: 'Value'
                        }
...
// Function to fetch data from get-all.php
function fetchDonationData() {
    $.ajax({
        url: '/Dashboard/BarGraph/get-all.php',  // Replace with the correct path to your PHP file
        method: 'GET',
        dataType: 'json',
        success: function(response) {
            updateBarChart(response); // Call the function to update the chart
        },
        error: function(xhr, status, error) {
